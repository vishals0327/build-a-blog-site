 ...
 */
function webdroyd_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Web Droyd default saturation level.
	 *
	 * @since Web Droyd 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'webdroyd_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.webdroyd-front-page) .entry-title,
...
.colors-custom .webdroyd-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.webdroyd-front-page .panel-content .recent-posts article,
...
.colors-custom.webdroyd-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Web Droyd custom colors CSS.
	 *
	 * @since Web Droyd 1.0
	 *
	 ...
	 */
	return apply_filters( 'webdroyd_custom_colors_css', $css, $hue, $saturation );
}
